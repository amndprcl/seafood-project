...
<section class="products">
   ...
   <?php
     ...
     if($select_cart->rowCount() > 0){
        while($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)){
           ...
           $formatted_sub_total = "Rp. " . number_format($sub_total, 0, ',', '.');
  ...
  <form action="" method="post" class="box">
     ...
     <div class="sub-total"> sub total : <span><?= $formatted_sub_total; ?></span> </div>
  </form>
  <?php
        }
  ...
  ?>
   ...
   <div class="cart-total">
      <p>cart total : <span><?= $formatted_grand_total; ?></span></p>
      <a href="checkout.php?total_price=<?= $grand_total; ?>" class="btn <?= ($grand_total <= 0)?'disabled':''; ?>">proceed to checkout</a>
   </div>
   <div class="more-btn">
